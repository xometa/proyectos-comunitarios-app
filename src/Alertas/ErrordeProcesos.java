 ...
 * @author Sony
 */
public class ErrordeProcesos extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public ErrordeProcesos(JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
//       this.setIconImage(new ImageIcon(getClass().getResource("/Imagenes/loguito.png")).getImage());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ErrordeProcesos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ErrordeProcesos dialog = new ErrordeProcesos(new javax.swing.JFrame(), true);
