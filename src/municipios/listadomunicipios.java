 ...
 * @author Sony
 */
public class listadomunicipios extends javax.swing.JInternalFrame {

    dao_departamentos de = new dao_departamentos();
    Departamentos depa = new Departamentos();
    dao_municipios muni = new dao_municipios();
    DefaultTableModel modelo;
    Municipio municipio;
    Municipio municipio1 = new Municipio();
    Comunidades comuni = new Comunidades();
    ...
    public listadomunicipios() {
        initComponents();
        this.tablaMunicipios.getTableHeader().setDefaultRenderer(new EstiloTablaHeader());
        this.tablaMunicipios.setDefaultRenderer(Object.class, new EstiloTablaRenderer());
        this.tablaMunicipios.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
    ...
    void ocultar_columnas() {
        this.tablaMunicipios.getColumnModel().getColumn(0).setMaxWidth(0);
        this.tablaMunicipios.getColumnModel().getColumn(0).setMinWidth(0);
        this.tablaMunicipios.getColumnModel().getColumn(0).setPreferredWidth(0);
    }
    ...
    private void initComponents() {
        ...
        tablaMunicipios.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        tablaMunicipios.setForeground(new java.awt.Color(255, 255, 255));
        ...
        tablaMunicipios.setDoubleBuffered(true);
        tablaMunicipios.setRowHeight(20);
        tablaMunicipios.setSelectionBackground(new java.awt.Color(0, 153, 255));
        tablaMunicipios.getTableHeader().setReorderingAllowed(false);
        jScrollPane1.setViewportView(tablaMunicipios);
        if (tablaMunicipios.getColumnModel().getColumnCount() > 0) {
            tablaMunicipios.getColumnModel().getColumn(0).setMinWidth(70);
            tablaMunicipios.getColumnModel().getColumn(0).setMaxWidth(70);
        }
        ...
        buscar.setPlaceholder("BUSCAR MUNICIPIO");
        ...
        combodepartamentos.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Seleccione" }));
        ...
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel7)
                    .addComponent(combodepartamentos, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jLabel1.setText("Listado de Municipios");
    ...
    private void btneliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btneliminarActionPerformed
        if (this.tablaMunicipios.getRowCount() < 1) {
            ...
            if (this.tablaMunicipios.getSelectedRowCount() < 1) {
                ErrordeProcesos er = new ErrordeProcesos(new JFrame(), true);
                er.titulo.setText("OOPS...");
                ...
                int fila = this.tablaMunicipios.getSelectedRow();
                int idmuni = Integer.parseInt(this.tablaMunicipios.getValueAt(fila, 0).toString());
                comuni = validar.buscaridmunicipio(idmuni);
                alcald = validar.buscaridmuni(idmuni);
                if (comuni == null && alcald == null) {
                    ...
                    if (AlertadeEliminacion.salir == true) {
                        wa.nombre.setText(this.tablaMunicipios.getValueAt(fila, 2).toString());/*agarrando el dato del nombre de la tabla para proceder 
                    a la busqueda para eliminarlo con la lista circular doble*/
                        municipio = new Municipio(wa.nombre.getText());
                        Nodo dato = muni.lsm.eliminar(municipio);/*salvando el registro eliminado de la lista*/
                        if (dato != null) {
                            muni.eliminar((Municipio) dato.getA());/*eliminando el registro de la base de datos*/
                            llenarTabla();
...
//        llenarTabla();
    ...
    private void btneditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btneditarActionPerformed
        ...
        if (this.tablaMunicipios.getRowCount() < 1) {
            ...
            if (this.tablaMunicipios.getSelectedRowCount() < 1) {
                ...
                int fila = this.tablaMunicipios.getSelectedRow();
                id.setText(this.tablaMunicipios.getValueAt(fila, 0).toString());
                codigo.setText(this.tablaMunicipios.getValueAt(fila, 1).toString());
                nombre.setText(this.tablaMunicipios.getValueAt(fila, 2).toString());
                combodepartamentos.setSelectedItem(this.tablaMunicipios.getValueAt(fila, 3));
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        String departamento = this.combodepartamentos.getSelectedItem().toString();
        depa = buscarID(departamento);
        municipio = new Municipio();
        if (!this.nombre.getText().isEmpty() && !this.codigo.getText().isEmpty() && combodepartamentos.getSelectedIndex() != 0) {
            /*seteando los datos para mandarlos a la base de datos*/
            municipio.setNombre(nombre);
            municipio.setCodigo(codigo);
            municipio.setIddepartamento(depa.getIddepartamento());
            municipio1 = buscarmunicipio(nombre);
            ...
            if (this.btnGuardar.getText().equals("GUARDAR")) {
                if (municipio1 == null) {
                    ...
                    er.msj.setText("EL MUNICIPIO YA HA SIDO INGRESADO");
                    er.msj1.setText("");
                    er.setVisible(true);
                }
            } else if (this.btnGuardar.getText().equals("ACTUALIZAR")) {
                municipio.setIdmunicipio(Integer.parseInt(this.id.getText()));
                muni.editar(municipio);
                ProcesoExitoso er = new ProcesoExitoso(new JFrame(), true);
    ...
    private void btnbuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnbuscarActionPerformed
        ...
        municipio = new Municipio(bsc);
        Nodo dato = muni.lsm.buscar(municipio);
        if (dato != null) {
            JOptionPane.showMessageDialog(null, "DATOS DEL MUNICIPIO\n\n"
                    + "Código: " + ((Municipio) dato.getA()).getCodigo()
                    + "\nNombre del Municipio: " + ((Municipio) dato.getA()).getNombre()
                    + "\nDepartamento: " + ((Municipio) dato.getA()).getDepartamentos().getNombre(),
    ...
    public void llenarTabla() {
        muni = new dao_municipios();
        eliminarFilas();
        ocultar_columnas();
        int registros = 0;
        String[] m = new String[4];
        for (Municipio d : muni.llenarlista(muni.consultamunicipios())) {
            m[0] = String.valueOf(d.getIdmunicipio());
            m[1] = d.getCodigo();
            m[2] = d.getNombre();
            m[3] = d.getDepartamentos().getNombre();
            modelo.addRow(m);
            registros += 1;
        }
    ...
    public void limpiar() {
        this.nombre.setText("");
        this.codigo.setText("");
        this.combodepartamentos.setSelectedIndex(0);
    }

    /*METODOS PARA LOS DEPARTAMENTOS*/
    public void llenarcombodepartament() {
        for (Departamentos x : de.llenarlistacircularsimple(de.consultadepartamentos())) {
            combodepartamentos.addItem(x.getNombre());
        }
    }

    public Departamentos buscarID(String nombre) {
        for (Departamentos x : de.llenarlistacircularsimple(de.consultadepartamentos())) {
    ...
    /*METODO PARA BUSCAR MUNICIPIOS*/
    public Municipio buscarmunicipio(String d) {
        for (Municipio m : muni.consultamunicipios()) {
            if (m.getNombre().equals(d)) {
                return m;
            }
        }
        return null;
