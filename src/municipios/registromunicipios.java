 ...
 * @author Sony
 */
public class registromunicipios extends javax.swing.JFrame {
...
//        llenarCombobox();
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addComponent(combodepartamentos, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(combodepartamentos, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel2))))
                .addGap(74, 74, 74))
        );
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        int departamento = this.combodepartamentos.getItemAt(combodepartamentos.getSelectedIndex()).getIddepartamento();
        ...
        if (!this.nombre.getText().isEmpty() && !this.codigo.getText().isEmpty()) {
            ...
            municipios.setNombre(nombre);
            municipios.setCodigo(codigo);
            municipios.setIddepartamento(departamento);
            ...
            if (this.btnGuardar.getText().equals("GUARDAR")) {
                muni.insertar(municipios);
                JOptionPane.showMessageDialog(null, "Guardado con exito");
                limpiar();
            } else if(this.btnGuardar.getText().equals("ACTUALIZAR")){
                municipios.setIdmunicipio(Integer.parseInt(this.id.getText()));
                muni.editar(municipios);
...
//        for (Departamentos d : llenarpila(de.consultadepartamentos())) {
//            combodepartamentos.addItem(d.getNombre());
//        }
//    }

//    /*metodo para llenar la pila con lo que posee la base de datos*/
//    public ArrayList<Departamentos> llenarpila(ArrayList<Departamentos> d) {
...
//    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(registromunicipios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new registromunicipios().setVisible(true);
            }
        });
    }
    ...
    public javax.swing.JComboBox<Departamentos> combodepartamentos;
