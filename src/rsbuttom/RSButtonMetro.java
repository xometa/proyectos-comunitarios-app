...
public class RSButtonMetro extends JButton implements MouseListener, MouseMotionListener {
     ...
     */
    private Color colorNormal = new Color(5,4,8);
    private Color colorPressed = new Color(0, 204, 0);   
    private Color colorHover = new Color(49, 47, 49);
    ...
    private Color colorTextHover = new Color(0, 204, 0);
